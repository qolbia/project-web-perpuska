...
<input name="penulis" type="text" class="form-control mb-2" placeholder="Penulis" required>
...
<input name="sinopsis" type="number" maxlength="4" class="form-control mb-2" placeholder="Sinopsis" required>
...
$status = "tersedia";
include'../koneksi.php';
$query = "INSERT INTO buku (judul_buku, penulis, penerbit, tahun_terbit, status, sinopsis)VALUES('$judul_buku', '$penulis', '$penerbit', '$tahun_terbit', '$status', '$sinopsis')";
